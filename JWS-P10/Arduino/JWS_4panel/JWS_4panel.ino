...
const char namaMasjid[] PROGMEM = "MASJID AL-IKHWAN LESONG DAYA KAMPONG TENGAH BATUMARMAR PAMEKASAN";
const char tmpIqomah[] PROGMEM = "LURUS DAN RAPATNYA SHAF TERMASUK KESEMPURNAAN SHOLAT BERJEMAAH";
const char info[] PROGMEM = "BARANG SIAPA MENINGGALKAN SHOLAT YANG WAJIB DENGAN SENGAJA MAKA JANJI ALLAH TERLEPAS DARINYA =H.R MUSLIM=";

const char jpaing[]  PROGMEM  = "JUM'AT PAHING  KHOTIB : K. KHOZIN ABDULLAH, BILAL : UST JUM'AH";
const char jpon[]    PROGMEM  = "JUM'AT PON  KHOTIB : K. MASYHUDI ALI, BILAL : UST MISNUTO";
const char jwage[]   PROGMEM  = "JUM'AT WAGE  KHOTIB : K. AL KARONI, BILAL : UST TAUHIDI";
const char jkliwon[] PROGMEM  = "JUM'AT KLIWON  KHOTIB : K. HASBULLAH, BILAL : UST ROFI'I";
const char jlegi[]   PROGMEM  = "JUM'AT MANIS  KHOTIB : K. FAUZI MOHAMMAD AL MAHAZZAIN, BILAL : UST JURIADI";
...
const char *const infoTabel[]    PROGMEM = {namaMasjid,tmpIqomah,info};
