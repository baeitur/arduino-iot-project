...
const char namaMasjid[] PROGMEM = "MASJID AL-MUNAWWAROH POWAK AHADAN DESA TLONTO RAJA PASEAN PAMEKASAN";
const char tmpIqomah[] PROGMEM = "LURUS DAN RAPATNYA SHAF TERMASUK KESEMPURNAAN SHOLAT BERJEMAAH";
const char info[] PROGMEM = "MASJID AL-MUNAWWAROH POWAK AHADAN DESA TLONTO RAJA PASEAN PAMEKASAN";

const char jpaing[]  PROGMEM  = "JUM'AT PAHING  KHOTIB : K FATHOR, BILAL : UST SADILI";
const char jpon[]    PROGMEM  = "JUM'AT PON  KHOTIB : K. ANAS, BILAL : UST TOYO";
const char jwage[]   PROGMEM  = "JUM'AT WAGE  KHOTIB : KH. FAUZI, BILAL : UST ALI MUDDIN";
const char jkliwon[] PROGMEM  = "JUM'AT KLIWON  KHOTIB : K. ABDUL AZIZ, BILAL : UST MANSUR";
const char jlegi[]   PROGMEM  = "JUM'AT LEGI  KHOTIB : KH. FAUZI, BILAL : UST ALI WAFA";
