...
void alarmMurottal() {  
  ...
  if (configmurottal.murottals>0){  
   if(time_now == murottal.shubuh and rDet < 3 && configmurottal.murottals!=5){
    relay_state=true;
    playMurottal();  
    tmploop=5;
  ...
  if(rHar==5){
   ...
   if (configmurottal.murottald>0){  
    if(time_now == murottal.dzuhur and rDet < 3 && configmurottal.murottald!=5){
     relay_state=true;
     playMurottal();  
     tmploop=5;
  ...
  if (configmurottal.murottala>0){  
   if(time_now == murottal.ashar and rDet < 3 && configmurottal.murottala!=5){
    relay_state=true;
    playMurottal();  
    tmploop=5;
  ...
  if (configmurottal.murottalm>0){  
   if(time_now == murottal.magrib and rDet < 3 && configmurottal.murottalm!=5){
    relay_state=true;
    playMurottal();  
    tmploop=5;
  ...
  if (configmurottal.murottali>0){  
   if(time_now == murottal.isya and rDet < 3 && configmurottal.murottali!=5){
    relay_state=true;
    playMurottal();  
    tmploop=5;
