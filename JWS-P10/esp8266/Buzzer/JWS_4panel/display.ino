...
void tmpJam(){
  ...
  if(rDet%2==0){
   ...
   Disp.drawCircle(33, 4, 1);Disp.drawCircle(33, 11, 1);
  }
  else {
   Disp.drawFilledCircle(15, 4, 1);Disp.drawFilledCircle(15, 11, 1);
   Disp.drawFilledCircle(33, 4, 1);Disp.drawFilledCircle(33, 11, 1);
  }
}
...
void Utama(){
  if(tmputama==0){
   ...
   if((rHar==4 && rJam>16)||(rHar==5 && rJam<16)){
    tmpInfo("Jum'at Selanjutnya ...");
    tmpJam();
    tmpJadwalSholat();
   }else{
...
void Iqomah() {
  ...
  Disp.setFont(ElektronMart6x8);
  Disp.drawText(22,4, "IQOMAH");
  sprintf(bufferIqom, "%02d:%02d", menitiqmh, detikiqmh);
  Disp.drawText(74,4, bufferIqom);
